...
function countdown(title, totime) {
	...
	setInterval(function () {
		...
		nowEle = document.getElementById('countdown_year');
		nowEle.innerHTML = pad(cd.years(),4);
		if (cd.years() == 0 && !nowEle.classList.contains('dimgrey')) nowEle.className += " dimgrey";
		if (cd.years() != 0 && nowEle.classList.contains('dimgrey')) nowEle.className -= " dimgrey";
		nowEle = document.getElementById('countdown_month');
		nowEle.innerHTML = pad(cd.months(),2);
		if (cd.months() == 0 && !nowEle.classList.contains('dimgrey')) nowEle.className += " dimgrey";
		if (cd.months() != 0 && nowEle.classList.contains('dimgrey')) nowEle.className -= " dimgrey";
		nowEle = document.getElementById('countdown_day');
		nowEle.innerHTML = pad(cd.days(),2);
		if (cd.days() == 0 && !nowEle.classList.contains('dimgrey')) nowEle.className += " dimgrey";
		if (cd.days() != 0 && nowEle.classList.contains('dimgrey')) nowEle.className -= " dimgrey";
